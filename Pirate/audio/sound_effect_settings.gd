...
## Credit to Aarimous: https://github.com/Aarimous/AudioManager
...
@export var type := SoundEffectType.NONE # The unique sound effect in the [enum SoundEffectType] to associate with this effect. Each SoundEffect resource should have it's own unique [enum SOUND_EFFECT_TYPE] setting.
